# Quem sou eu? :pushpin:
Meu nome é João Rodrigo, sou graduado em Contabilidade pela Universidade de São Paulo (USP). Tenho experiência trabalhando na área de Modelagem de Riso, porém atualmente trabalho com consultoria financeira e possuo grande interesse por ciência de dados, programação e Machine Learning!
